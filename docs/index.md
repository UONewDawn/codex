...
-   :material-map-marker:{ .lg .middle } __Getting Started__

    ---

    New to New Dawn? Start here to learn the basics and get your adventure underway.

    [:octicons-arrow-right-24: New Player Guide](getting-started/new-player-guide.md)

-   :material-sword:{ .lg .middle } __Game Mechanics__

    ---

    Learn about skills, stats, combat, magic, and crafting systems that power the game.

    [:octicons-arrow-right-24: Explore Mechanics](game-mechanics/index.md)

-   :material-castle:{ .lg .middle } __World__
