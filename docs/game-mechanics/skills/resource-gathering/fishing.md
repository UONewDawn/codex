...
=== "Skill requirements"
    ...
    |  90   |                                                                     ![item-icon](../../../assets/mobiles/sea-serpent.png)<br>Sea Serpents, Deep Sea Serpents<br>Drop details below                                                                     |
...
|                              Sea serpents loot                               |
|:----------------------------------------------------------------------------:|
|      ![item-icon](../../../assets/items/fishing-net.png)<br>Fishing Net      |
| ![item-icon](../../../assets/items/treasure-map.png)<br>Level 1 Treasure Map |
| ![item-icon](../../../assets/items/archaeology-clue.png)<br>Archaeology Clue |
|  ![item-icon](../../../assets/items/bottle-ale.png)<br>Message in a Bottle   |
